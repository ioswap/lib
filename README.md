...
[![npm](https://img.shields.io/npm/v/@io-swap/lib)](https://unpkg.com/@io-swap/lib@latest/)
...
Install this in another project via `yarn add @io-swap/lib`

Then import the contracts via:

```solidity
import '@io-swap/lib/contracts/libraries/Babylonian.sol';
